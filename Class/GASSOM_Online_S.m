classdef GASSOM_Online_S  < handle
    ...
    methods
        function obj = GASSOM_Online_S(PARAM)
            ...
            save_name = sprintf('temp_data/initbase_%d_by_%d_S.mat',obj.length_basis,obj.n_subspace);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   
        ...
        function [basis] = getBasis(this,ind)
            basis_ind = this.bases{1}(:,ind);
        ...
        function visualizeBases(this,iBase)
            if nargin<2
                for h = 1:this.size_subspace
                    this.h_plot{h} = plotBases(this.bases{h},this.dim_patch,this.topo_subspace,this.bi_flag);
                end      
            else
                this.h_plot{iBase} = plotBases(this.bases{iBase},this.dim_patch,this.topo_subspace,this.bi_flag);
            end            
        end
